...
@section('contenido')
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">IT´S SHOP-TIME</h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Abarrote
                                        </span>
                                        <span class="mr-2">
                          ...
                          <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>Aquí aparecerá una breve descripción sobre los productos añadidos al carrito <a
